/*=========================================================================
  ...
  Module:    igstkImageSliceObjectRepresentation.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __igstkImageSliceObjectRepresentation_txx
#define __igstkImageSliceObjectRepresentation_txx
...
ImageSliceObjectRepresentation< TImageSpatialObject >
::ImageSliceObjectRepresentation():m_StateMachine(this)
{
  ...
  // Setting of vtkImageProperty
    ...
    m_ImageProperty->SetBackingColor(0.0,0.0,0.0);
...
::DeleteActors( )
{
  igstkLogMacro( DEBUG, "igstk::ImageSliceObjectRepresentation\
                        ::DeleteActors called...\n");
...
{
  igstkLogMacro( DEBUG, 
    "igstk::ImageSliceObjectRepresentation::VerifyTimeStamp called...\n");
...
template < class TImageSpatialObject >
void ImageSliceObjectRepresentation< TImageSpatialObject >
...
template < class TImageSpatialObject >
typename ImageSliceObjectRepresentation< TImageSpatialObject >::Pointer
ImageSliceObjectRepresentation< TImageSpatialObject >
::Copy() const
{
  igstkLogMacro( DEBUG, "igstk::ImageSliceObjectRepresentation\
  ...
  Pointer newOR = ImageSliceObjectRepresentation::New();
