#ifndef __igstkImageSliceObjectRepresentationPlus_txx
#define __igstkImageSliceObjectRepresentationPlus_txx
...
ImageSliceObjectRepresentationPlus< TImageSpatialObject >
::ImageSliceObjectRepresentationPlus():m_StateMachine(this)
{
...
//	m_LookupTable->SetSaturationRange(0.667, 0); // color saturation 
//	m_LookupTable->SetNumberOfColors(256); 
	...
	//}
	//m_LookupTable->SetNumberOfTableValues(VTK_UNSIGNED_CHAR_MAX+1); 
	//m_LookupTable->SetRange(0.0, VTK_UNSIGNED_CHAR_MAX);
	//for(unsigned int i = 0; i <= VTK_UNSIGNED_CHAR_MAX; i++){
	//     double doubleIndex = static_cast<double>(i);
    //     m_LookupTable->SetTableValue(i, VTK_UNSIGNED_CHAR_MAX-doubleIndex, VTK_UNSIGNED_CHAR_MAX-doubleIndex, VTK_UNSIGNED_CHAR_MAX-doubleIndex,1.0);
	//}
//	m_LookupTable->SetHueRange (0.0,1.0);
	m_LookupTable->SetValueRange(0.0, 1.0);
    m_LookupTable->Build();
    
//	m_LookupTable->SetRange(0, 100); // image intensity range 
//	m_LookupTable->SetHueRange (0.3,1.0);
//	m_LookupTable->SetSaturationRange(1.0, 1.0); // color saturation 
//	m_LookupTable->SetAlphaRange (1.0, 1.0);	
 //   m_LookupTable->SetValueRange(0.0, 1.0); // from black to white 
//	m_LookupTable->SetVectorComponent(0); 
     

  this->AddActor( m_ImageSlice );
   
	m_ImageProperty->SetOpacity(0.5);
	m_ImageProperty->SetLookupTable(m_LookupTable);
...
template < class TImageSpatialObject >
ImageSliceObjectRepresentationPlus< TImageSpatialObject >
::~ImageSliceObjectRepresentationPlus()  
{
  this->DeleteActors();
...
template < class TImageSpatialObject >
void ImageSliceObjectRepresentationPlus< TImageSpatialObject >
...
template < class TImageSpatialObject >
typename ImageSliceObjectRepresentationPlus< TImageSpatialObject >::Pointer
ImageSliceObjectRepresentationPlus< TImageSpatialObject >
::Copy() const
{
  igstkLogMacro( DEBUG, "igstk::ImageResliceObjectRepresentation\
