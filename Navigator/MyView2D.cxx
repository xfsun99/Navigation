...
/** Constructor */
MyView2D::MyView2D() : m_StateMachine(this)
{
...
void MyView2D::PrintSelf( std::ostream& os, ::itk::Indent indent ) const
{
...
void MyView2D::RequestSetOrientation( const OrientationType & orientation )
{
  igstkLogMacro( DEBUG, "igstk::MyView2D::RequestSetOrientation called ....\n");
